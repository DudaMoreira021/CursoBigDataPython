...
try:
        ...
        match codigo:
                ...
                case 6:
                    print("O número 7 corresponde a região Nordeste.")
                case 7:
                ...
                case 9:
                        print("O número 8 corresponde a região Sudeste.")
                case 10:
                        print("O número 9 corresponde a região Centro-oeste.") 
                case 11:
                        print("O número 8 corresponde a região Noroeste.")

                case _:
                    print(f"Número {codigo} importado inválido. Digite entre 1 e 11.")
